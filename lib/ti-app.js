    ...
    function initMap() {
      ...
      var myMapType = new google.maps.ImageMapType({
        getTileUrl: function(coord, zoom) {
          return "http://tile.openweathermap.org/map/precipitation_new/"+zoom+"/"+coord.x+"/"+coord.y+".png?appid=200209f9ae4dc6b1ed27f9ad0bca1116&dummy="+(new Date()).getHours().toString()+(new Date()).getDate().toString();
        },
