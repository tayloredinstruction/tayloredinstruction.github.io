    ...
    function initMap() {
      ...
      var myMapType = new google.maps.ImageMapType({
        getTileUrl: function(coord, zoom) {
          return "http://tile.openweathermap.org/map/precipitation_new/"+zoom+"/"+coord.x+"/"+coord.y+".png?appid=b33c02fe5a68e46356570b59b171a517";
        },
	 ...
	 if(secName==="Any"){
         ...
         where:  "col15 \x3e\x3d "+miniVal+" and col15 \x3c\x3d "+maxiVal+" and col14 \x3e\x3d "+miniValg+" and col16 \x3c\x3d "+maxiValg+rivQuery+secQuery
             },
             options: {
         styleId: sid,
         templateId: tid
